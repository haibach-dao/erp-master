...
const ENTITY_TYPE_LABEL: Record<string, string> = {
  ...
  grave_plot: 'Phần mộ',
  grave_type: 'Loại mộ',
  grave_plot_tag_type: 'Danh mục thẻ nhãn phần mộ',
  customer_tag_type: 'Danh mục thẻ nhãn khách hàng',
  grave_plot_tag: 'Thẻ nhãn trên phần mộ',
  customer_tag: 'Thẻ nhãn trên khách hàng',
